  ...
  return (
    <div className="container">
      ...
      <ul className="tabs" onClick={props.toggleTab}>
        <li className={`tab ${database.tab === 'list' ? 'selected' : ''}`} id="list">List</li>
        <li className={`tab ${database.tab === 'json' ? 'selected' : ''}`} id="json">JSON</li>
      </ul>
      {
                      ...
                      <td>
                        {
                          Object.keys(entry).map((keyName) => {
                            ...
                            } else if (Array.isArray(pair) && typeof pair[0] !== 'object') {
                              return (
                                <p key={`${reactKey}`}>
